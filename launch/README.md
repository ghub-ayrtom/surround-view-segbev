...
`surround_view_launch.py` — launches the Webots world named ![main.wbt](https://github.com/ghub-ayrtom/surround-view-segbev/blob/main/resource/worlds/main.wbt), after which the ego vehicle starts autonomous movement according to the GPS coordinates specified in the ![gps_path_planning_node.py](https://github.com/ghub-ayrtom/surround-view-segbev/blob/main/surround_view_segbev/gps_path_planning_node.py) in the local Webots coordinate system. At the same time, ![surround_view_node.py](https://github.com/ghub-ayrtom/surround-view-segbev/blob/main/surround_view_segbev/surround_view_node.py) builds a segmented 360-degree local map around the robot:<br>

https://github.com/user-attachments/assets/b88a7c71-9da9-44a2-ad96-ae44bef95eeb

> [!NOTE]
> See ![docs](https://github.com/ghub-ayrtom/surround-view-segbev/tree/main/docs), [FastSeg model training](https://www.kaggle.com/code/ayrtom/fastseg-model-training), [YOLO model training](https://www.kaggle.com/code/ayrtom/yolo-model-training) Kaggle Notebooks and [Webots Road Segmentation](https://www.kaggle.com/datasets/ayrtom/webots-road-segmentation), [Webots Plastic barrels Detection](https://www.kaggle.com/datasets/ayrtom/webots-plastic-barrels-detection) Kaggle Datasets for details on working with deep learning models.

> [!IMPORTANT]
> To form a surround view, `surround_view_node` uses `masks.npy` and `weights.npy` pre-generated by the ![BEVFormer](https://github.com/ghub-ayrtom/surround-view-segbev/tree/main/surround_view_segbev/scripts/BEVFormer) tool. If you want to use your robot with a different position or number of cameras, please review ![docs](https://github.com/ghub-ayrtom/surround-view-segbev/tree/main/docs) and the ![original documentation](https://github.com/neozhaoliang/surround-view-system-introduction/blob/master/doc/en.md) before doing so. The current implementation of classes ![BirdsEyeView](https://github.com/ghub-ayrtom/surround-view-segbev/blob/main/surround_view_segbev/scripts/BirdsEyeView.py) and ![CameraModel](https://github.com/ghub-ayrtom/surround-view-segbev/blob/main/surround_view_segbev/scripts/CameraModel.py) is configured to work with 4 cameras (not fisheye) + 1 dummy (camera_front_blind) to remove the blind spot directly in front of the ego vehicle.
